	...
	<div class="headerblock-text-col">
		...
		<ul class="usps">
			<li>
				...
				<strong><?php _e('Industrial greenhouse projects', 'norhageindustri'); ?></strong>
			</li>
			<li>
				<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100" style="enable-background:new 0 0 100 100;" xml:space="preserve">
					<style type="text/css">.st0{fill:#0A4164;}</style>
				...
				<strong><?php _e('Installation services', 'norhageindustri'); ?></strong>
			</li>
			<li>
				<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100" style="enable-background:new 0 0 100 100;" xml:space="preserve">
					<style type="text/css">.st0{fill:#0A4164;}</style>
				...
				<strong><?php _e('Maintenance & restoration', 'norhageindustri'); ?></strong>
			</li>
			<li>
				<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100" style="enable-background:new 0 0 100 100;" xml:space="preserve">
				...
				<strong><?php _e('Roofing & facade, PVC curtains', 'norhageindustri'); ?></strong>
			</li>
		</ul>
	</div>
